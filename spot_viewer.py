...
def _plot_frame(video, x_zoom_pos, y_zoom_pos, frame_number):
    ...
    for c in [0, 1]:
        ...
        axes[c].imshow(video[idx, ..., c], cmap="inferno_r")
        ...
        axes[c + 2].imshow(video[idx, ..., 0], cmap="inferno_r")
...
if __name__ == "__main__":
    ...
    fig, axes = _plot_frame(video = video, x_zoom_pos = x_mean, y_zoom_pos = y_mean, frame_number = frame_number)
    x_ = int(x_coords[idx])
    y_ = int(y_coords[idx])
